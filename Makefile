...
data/json/towns.geo.json: data/json/TOWNSSURVEY_POLYM.json
	./scripts/add-feature-id.js data/json/TOWNSSURVEY_POLYM.json > $@

public/data/towns.json: data/json/towns.geo.json
	mkdir -p $(dir $@)
